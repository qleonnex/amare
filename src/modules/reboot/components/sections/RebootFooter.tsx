      ...
      <div className="max-w-[1350px] mx-auto px-4">
        ...
        <div className="max-w-full opacity-60 text-center mt-16">
          <div className="flex items-center justify-center gap-3.5 text-sm underline mb-3">
            <a href="/files/privacy-policy.docx" download>
              Политика конфиденциальности
            </a>
            <a href="/files/offer.docx" download>
              Договор оферты
            </a>
          </div>
          <p className="text-sm">
            Мы предоставляем возможность оплатить покупку онлайн непосредственно
            через интернет-магазин. К оплате принимаются пластиковые карты VISA,
            MasterCard и МИР, а также СБП и рассрочка. Прием оплат
            осуществляется при помощи платежного решения GetCourse (Get Модуль).
            Платежи, при этом данные карт и клиента передаются по защищенным
            каналам связи. Приём платежей происходит через защищённое безопасное
            соединение, используется SSL протокол.
          </p>
        </div>
      </div>
    </div>
